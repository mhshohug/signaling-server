  ...
  io.on('connection', (socket) => {
    ...
    const handleCallUser = async (data) => {
      ...
      if (targetUser) {
        ...
        logger.info(`[SOCKET_CALL] Target user ${targetUserId} is online. Emitting incoming_call via Socket.IO.`);
      ...
      // Always send high-priority FCM notification as well to guarantee delivery in background/killed states
