  ...
  io.on('connection', (socket) => {
    ...
    socket.on('call_user', async (data) => {
      ...
      if (targetUser) {
        ...
        // Do NOT rely on Socket.IO for the initial incoming call signal.
      }

      // Do NOT depend on Socket.IO for delivering the initial incoming call.
      // Socket.IO should only be used after the user opens or accepts the call.
      // Always trigger high-priority FCM notification to ensure delivery even if removed from Recent Apps.
